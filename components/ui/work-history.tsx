...
/**
 * Entries come from `GET /api/experience?lang=…`, already localized, so the
 * text fields are read directly. `currentLang` only picks the UI labels.
 */
const WorkHistory = ({ experiences }: { experiences: WorkExperience[] }) => {
